...
Render runs pending tracked migrations before it starts Express. Production startup does not seed or reset data. Configure variables from `/cyberscout-server/.env.example` and see [`SUPABASE_POSTGRESQL.md`](SUPABASE_POSTGRESQL.md).

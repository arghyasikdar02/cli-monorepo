      ...
      <section className="hidden lg:flex w-5/12 bg-[#020617] flex-col justify-between p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-on-primary-container text-base">
            Hands-on labs, AI tutoring, and real-world scenarios for practical cybersecurity learning.
          </p>
        </div>

        <div className="relative z-10 grid grid-cols-2 gap-3">
          {[['2', 'Courses'], ['Guided', 'Labs'], ['Beginner', 'Level'], ['Hands-On', 'Practice']].map(([num, label]) => (
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 shadow-[0_24px_80px_rgba(15,23,42,0.10)] p-8">
            ...
            >
              ...
              <span className="text-on-surface text-sm font-medium">Continue with Google</span>
            </button>

  ...
  return (
    <header className="app-top-bar sticky top-0 z-40 h-16 bg-white/95 border-b border-slate-200 flex items-center justify-between px-8">
      <div className="app-top-bar-start">
        {onMenuOpen && <button type="button" className="app-mobile-nav-button" onClick={onMenuOpen} aria-label="Open learner navigation"><SiteIcon name="menu" /></button>}
      ...
      <div className="flex items-center gap-4">
        <Link to="/notifications" className="relative text-slate-500 hover:text-violet-600 transition-colors" aria-label="Course notifications"><SiteIcon name="notifications" size={22} /></Link>
